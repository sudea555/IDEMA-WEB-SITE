...
(function () {
  ...
  const translations = {
    en: {
      ...
      contactHeading: "Tell us what you're building — we'll tell you how fast we can make it",
      contactAddressLabel: 'ADDRESS',
      contactEmailLabel: 'EMAIL',
      contactPhoneLabel: 'PHONE',
      contactCoordsLabel: 'COORDINATES',
      ...
      aboutP1: 'İDEMA has spent 14 years serving international markets through scalable, reliable production — supporting wholesalers, distributors, e-commerce brands, retailers and project-based businesses with manufacturing structures that adapt to their models and technical requirements.',
      aboutP2: 'Every stage runs in-house, managed by our engineering team and 100+ production professionals from our Phase 1 facility — built on structured planning, transparent communication and on-time delivery.',
      ...
      aboutCardArea: '6,000 M² · PHASE 1',
      aboutCardCapacity: '15–23K UNITS / MO',
      ...
      whyItem1: '<strong>Flexible production structure</strong> — adapts to your business model, technical needs and market expectations.',
    ...
    tr: {
      ...
      contactHeading: 'Ne ürettiğinizi anlatın — ne kadar hızlı üretebileceğimizi söyleyelim',
      contactAddressLabel: 'ADRES',
      contactEmailLabel: 'E-POSTA',
      contactPhoneLabel: 'TELEFON',
      contactCoordsLabel: 'KOORDİNATLAR',
      ...
      aboutP1: 'İDEMA, 14 yıldır ölçeklenebilir ve güvenilir üretimle uluslararası pazarlara hizmet veriyor — toptancıları, distribütörleri, e-ticaret markalarını, perakendecileri ve proje bazlı işletmeleri, kendi modellerine ve teknik gereksinimlerine uyum sağlayan üretim yapılarıyla destekliyoruz.',
      aboutP2: "Her aşama, Faz 1 tesisimizdeki mühendislik ekibimiz ve 100'den fazla üretim profesyoneli tarafından; yapılandırılmış planlama, şeffaf iletişim ve zamanında teslimat üzerine kurulu şekilde tamamen kendi bünyemizde yürütülür.",
      ...
      aboutCardArea: '6.000 M² · FAZ 1',
      aboutCardCapacity: 'AYDA 15–23K ÜNİTE',
      ...
      whyItem1: '<strong>Esnek üretim yapısı</strong> — iş modelinize, teknik ihtiyaçlarınıza ve pazar beklentilerinize uyum sağlar.',
